            ...
            if (typeof data !== 'undefined' && data !== null) {
                ...
                if (data['capacity'] > 1) {
                    ...
                    for (let i = 1; i < data['capacity']; i++) {
                        ...
                        newInput.classList.add('extra-people','form-group','input-group','mb-auto','auto-email');
                        newInput.innerHTML = '<div class="input-group-prepend">' + '\n' + '<label class="input-group-text">IIT Email</label>' + '\n' + '</div>' + '\n' +
                            '<input class="form-control" type="email" id="user' + i + '" name="user' + i + '" value="" placeholder="Optional">' + '\n' +
